    ...
    switch(operator){
        case 1:{
            if(firstNumber!=0 && secondNumber!=0){
                ...
                localStorage.setItem("First value + Second value :", sn +""+"+"+""+fn);
                localStorage.setItem("Solution :" , co);
                sessionStorage.setItem("First value + Second value :", sn +""+"+"+""+fn);
                sessionStorage.setItem("Solution :" , co);
                secondNumber = co;
                co=0;
                operator = 0;
                firstNumber =0;
